...
namespace TestCoin.Blockcode
{
    ...
    public class Block
    {
        ...
        public Block(int index, List<Transaction> transactions, String prevHash = "", double reward = 0, String minerAddress = "TestCoin Miner Reward", double fees = 0)
        {
            this.index = index;
        ...
        public void mineBlock(float difficulty, Blockchain bChain, Block block, int threads = 4)
        {
        ...
        public static bool Compare(Block b1, Block b2)
        {
