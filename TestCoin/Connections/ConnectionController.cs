...
namespace TestCoin.Connections
{
    public class ConnectionController
    {
        ...
        public ConnectionController(Func<string,bool> cb, Func<int,bool> pCb, Func<string,bool> invoker, Form1 f, Blockchain bC, Func<int,bool> autoLoader, Tangle tangle)
        {
            GetLocalIP();
            GetPublicIP();
            callback = cb;
            ...
            chain = bC;
            this.tangle = tangle;
            tangle.NewTranCallback = NewTangleTransaction;
            reader = new MessageReader(form, chain, TogglePing, conPool,tangle);
        ...
        private void ServerRun()
        {
            try
            {
                ...
                tangle.defaultPort = defaultPort;
                ...
                else if (local)
                {
                    ...
                    Packet genCheck = new Packet(serverIP, 20000, "REQUEST.GENESIS");
                    msgQueue.Add(genCheck);
                }
                ...
                while (true)
                {
                    ...
                    {
                        Console.WriteLine("Listener Crash: " + e.ToString());
                    }
        ...
        public bool NewTangleTransaction(TangleTransaction tran)
        {
